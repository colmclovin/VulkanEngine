...
void FurnaceRecipeDatabase::Init() {
    s_Recipes[ItemId::CopperOre] = { ItemId::CopperPlate, 1.0f };
    s_Recipes[ItemId::IronOre] = { ItemId::IronPlate, 1.0f };
    s_Recipes[ItemId::StoneOre] = { ItemId::StoneBricks, 1.0f };
    s_Recipes[ItemId::IronPlate] = { ItemId::Steel, 5.0f };
}
